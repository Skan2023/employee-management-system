                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-<?php
                                                                        echo $leave['status'] == 'approved' ? 'success' : ($leave['status'] == 'pending' ? 'warning' : 'danger');
                                                                        ?>">
    ...
    <?php elseif ($_SESSION['role'] === 'employee'): ?>
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <p>This is your employee dashboard. Here you can view your leave requests and personal information.</p>
                <a href="<?php echo BASE_URL; ?>leaverequest" class="btn btn-primary">View My Leave Requests</a>
            </div>
        </div>
    <?php endif; ?>
</div>
